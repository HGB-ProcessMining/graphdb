...
driver = GraphDatabase.driver("bolt://" + DB_HOST + ":" + DB_PORT, auth=(DB_USER, DB_PASSWORD))
...
def create_entity(tx, entity_type, entity_id, WHERE_event_property): # todo
    qCreateEntity = f'''
